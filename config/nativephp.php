...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'cl.edificio.registropropietarios'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Registro de Propietarios'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Gestión local de propietarios, arrendatarios y personas autorizadas.'),
